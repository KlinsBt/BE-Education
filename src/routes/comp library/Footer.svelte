...
<main>
    ...
    <footer>
        ...
        <div class="contact">
            ...
            <!-----<p><a itemprop="email" href="mailto:dennyberndt@outlook.de">dennyberndt@outlook.de</a></p>---->
        </div>
...
@media (min-width: 300px) and (max-width: 531px) {
...
@media (min-width: 532px) and (max-width: 835px) {
